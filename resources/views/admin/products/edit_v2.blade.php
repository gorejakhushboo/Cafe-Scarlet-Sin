...
<form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <div class="mb-2" id="imagePreviewContainer" style="margin-top: 10px; padding: 10px; border: 1px dashed #666; display: none;">
            <p style="margin: 0; color: #aaa; font-size: 0.8rem;">New Image Preview:</p>
            <img id="imagePreview" src="#" alt="New Image Preview" style="max-height: 200px; max-width: 100%; border: 1px solid #ddd; padding: 5px; display: block; margin-top: 5px;">
        </div>
    </div>
...
<script>
    function previewImage(input) {
        console.log('Direct onchange fired (Edit)!');
